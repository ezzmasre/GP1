...
class Doctor extends StatefulWidget {
  ...
  @override
  State<Doctor> createState() => _UDoctor();
}

class _UDoctor extends State<Doctor> {
  ...
  Future<void> fetchUsers() async {
    final url = Uri.parse('https://fitnes-bakeend.onrender.com/pro_users/doctor');
  ...
  Future<void> deleteUser(dynamic user) async {
    final url =
        Uri.parse('https://fitnes-bakeend.onrender.com/pro_users/${user['email']}');
