...
class Tricibsvedios extends StatefulWidget {
  const Tricibsvedios({super.key});

  @override
  State<Tricibsvedios> createState() => _ChestvideospageState();
}

class _ChestvideospageState extends State<Tricibsvedios> {
  List<Map<String, String>> chestVideos = [];

  @override
  void initState() {
    super.initState();
    searchById("trysibs .email", 'chest');
  }
  ...
  void delethhtp(String id) async {
    ...
    try {
      final request = http.Request('DELETE', url)
        ...
        ..body = json.encode({
          'productId': "674c09e70f98bdbd51e2ede8",
        });
  ...
  void addvediotolist(String id, String title, String description) async {
    final url = Uri.parse(
        'https://fitnes-bakeend.onrender.com/update-fitnes/674c09e70f98bdbd51e2ede8');
  ...
  void callhttp(String id, String title, String description) async {
    ...
    try {
      final response = await http.put(
        ...
        body: json.encode({
          'id':
              '674c09e70f98bdbd51e2ede8', // Add 'id' (the MongoDB document ID)
