...
class Knee extends StatefulWidget {
  ...
  @override
  State<Knee> createState() => _ChestvideospageState();
}

class _ChestvideospageState extends State<Knee> {
  List<Map<String, String>> chestVideos = [];

  @override
  void initState() {
    super.initState();
    searchById("Knee.email", 'chest');
  }
  ...
  void delethhtp(String id) async {
    ...
    try {
      final request = http.Request('DELETE', url)
        ...
        ..body = json.encode({
          'productId': "6771abcd2144276c57febda9",
        });
  ...
  void addvediotolist(String id, String title, String description) async {
    final url = Uri.parse(
        'https://fitnes-bakeend.onrender.com/update-fitnes/6771abcd2144276c57febda9');
  ...
  void callhttp(String id, String title, String description) async {
    ...
    try {
      final response = await http.put(
        ...
        body: json.encode({
          'id':
              '6771abcd2144276c57febda9', // Add 'id' (the MongoDB document ID)
