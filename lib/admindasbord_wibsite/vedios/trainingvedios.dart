...
class Trainingvedios extends StatefulWidget {
  const Trainingvedios({super.key});

  @override
  State<Trainingvedios> createState() => _ChestvideospageState();
}

class _ChestvideospageState extends State<Trainingvedios> {
  List<Map<String, String>> chestVideos = [];

  @override
  void initState() {
    super.initState();
    searchById("Trainng.gmail", 'chest');
  }
  ...
  void delethhtp(String id) async {
    ...
    try {
      final request = http.Request('DELETE', url)
        ...
        ..body = json.encode({
          'productId': "67474bec690ea8a2204dd3e0",
        });
  ...
  void addvediotolist(String id, String title, String description) async {
    final url = Uri.parse(
        'https://fitnes-bakeend.onrender.com/update-fitnes/67474bec690ea8a2204dd3e0');
  ...
  void callhttp(String id, String title, String description) async {
    ...
    try {
      final response = await http.put(
        ...
        body: json.encode({
          'id':
              '67474bec690ea8a2204dd3e0', // Add 'id' (the MongoDB document ID)
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: chestVideos.isEmpty
            ? const Center(
                child: CircularProgressIndicator(color: Color(0xffD5FF5F)))
                  ...
                  children: [
                    ...chestVideos.asMap().entries.map((entry) {
                      ...
                      return Padding(
                        ...
                        child: Card(
                          elevation: 8,
                          color: Color(0xff3C3C3C), // Set card color
