...
class Chestvideospage extends StatefulWidget {
  const Chestvideospage({super.key});

  @override
  State<Chestvideospage> createState() => _ChestvideospageState();
}

class _ChestvideospageState extends State<Chestvideospage> {
  ...
  void delethhtp(String id) async {
    ...
    try {
      final request = http.Request('DELETE', url)
        ...
        ..body = json.encode({
          'productId': "673ed706a3dfd688919cb962",
        });
  ...
  void addvediotolist(String id, String title, String description) async {
    final url = Uri.parse(
        'https://fitnes-bakeend.onrender.com/update-fitnes/673ed706a3dfd688919cb962');
  ...
  void callhttp(String id, String title, String description) async {
    ...
    try {
      final response = await http.put(
        ...
        body: json.encode({
          'id':
              '673ed706a3dfd688919cb962', // Add 'id' (the MongoDB document ID)
            ...
            children: [
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  labelStyle: TextStyle(color: const Color(0xffD5FF5F)),
                ),
                style: TextStyle(color: const Color(0xffD5FF5F)),
              ),
