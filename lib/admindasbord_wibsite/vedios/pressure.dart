...
class Pressure extends StatefulWidget {
  ...
  @override
  State<Pressure> createState() => _ChestvideospageState();
}

class _ChestvideospageState extends State<Pressure> {
  List<Map<String, String>> chestVideos = [];

  @override
  void initState() {
    super.initState();
    searchById("pressure.email", 'chest');
  }
  ...
  void delethhtp(String id) async {
    ...
    try {
      final request = http.Request('DELETE', url)
        ...
        ..body = json.encode({
          'productId': "6771a94d2144276c57febda8",
        });
  ...
  void addvediotolist(String id, String title, String description) async {
    final url = Uri.parse(
        'https://fitnes-bakeend.onrender.com/update-fitnes/6771a94d2144276c57febda8');
  ...
  void callhttp(String id, String title, String description) async {
    ...
    try {
      final response = await http.put(
        ...
        body: json.encode({
          'id':
              '6771a94d2144276c57febda8', // Add 'id' (the MongoDB document ID)
