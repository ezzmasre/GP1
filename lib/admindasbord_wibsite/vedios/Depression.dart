...
class Depression extends StatefulWidget {
  ...
  @override
  State<Depression> createState() => _ChestvideospageState();
}

class _ChestvideospageState extends State<Depression> {
  List<Map<String, String>> chestVideos = [];

  @override
  void initState() {
    super.initState();
    searchById("Depression.email", 'chest');
  }
  ...
  void delethhtp(String id) async {
    ...
    try {
      final request = http.Request('DELETE', url)
        ...
        ..body = json.encode({
          'productId': "677249a2d1eb36a2280d3559",
        });
  ...
  void addvediotolist(String id, String title, String description) async {
    final url = Uri.parse(
        'https://fitnes-bakeend.onrender.com/update-fitnes/677249a2d1eb36a2280d3559');
  ...
  void callhttp(String id, String title, String description) async {
    ...
    try {
      final response = await http.put(
        ...
        body: json.encode({
          'id':
              '677249a2d1eb36a2280d3559', // Add 'id' (the MongoDB document ID)
