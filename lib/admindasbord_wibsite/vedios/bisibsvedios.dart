...
class Bisibsvedios extends StatefulWidget {
  const Bisibsvedios({super.key});

  @override
  State<Bisibsvedios> createState() => _ChestvideospageState();
}

class _ChestvideospageState extends State<Bisibsvedios> {
  List<Map<String, String>> chestVideos = [];

  @override
  void initState() {
    super.initState();
    searchById("bicebs.email", 'chest');
  }
  ...
  void delethhtp(String id) async {
    ...
    try {
      final request = http.Request('DELETE', url)
        ...
        ..body = json.encode({
          'productId': "6747272a833f1cf20b63fe31",
        });
  ...
  void addvediotolist(String id, String title, String description) async {
    final url = Uri.parse(
        'https://fitnes-bakeend.onrender.com/update-fitnes/6747272a833f1cf20b63fe31');
  ...
  void callhttp(String id, String title, String description) async {
    ...
    try {
      final response = await http.put(
        ...
        body: json.encode({
          'id':
              '6747272a833f1cf20b63fe31', // Add 'id' (the MongoDB document ID)
