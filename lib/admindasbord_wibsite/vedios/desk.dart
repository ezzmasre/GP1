...
class Desk extends StatefulWidget {
  ...
  @override
  State<Desk> createState() => _ChestvideospageState();
}

class _ChestvideospageState extends State<Desk> {
  List<Map<String, String>> chestVideos = [];

  @override
  void initState() {
    super.initState();
    searchById("desk.email", 'chest');
  }
  ...
  void delethhtp(String id) async {
    ...
    try {
      final request = http.Request('DELETE', url)
        ...
        ..body = json.encode({
          'productId': "6771a61a2144276c57febda6",
        });
  ...
  void addvediotolist(String id, String title, String description) async {
    final url = Uri.parse(
        'https://fitnes-bakeend.onrender.com/update-fitnes/6771a61a2144276c57febda6');
  ...
  void callhttp(String id, String title, String description) async {
    ...
    try {
      final response = await http.put(
        ...
        body: json.encode({
          'id':
              '6771a61a2144276c57febda6', // Add 'id' (the MongoDB document ID)
