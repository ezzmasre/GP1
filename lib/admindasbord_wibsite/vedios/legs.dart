...
class Legs extends StatefulWidget {
  ...
  @override
  State<Legs> createState() => _ChestvideospageState();
}

class _ChestvideospageState extends State<Legs> {
  List<Map<String, String>> chestVideos = [];

  @override
  void initState() {
    super.initState();
    searchById("legs.email", 'chest');
  }
  ...
  void delethhtp(String id) async {
    ...
    try {
      final request = http.Request('DELETE', url)
        ...
        ..body = json.encode({
          'productId': "674729fc833f1cf20b63fe33",
        });
  ...
  void addvediotolist(String id, String title, String description) async {
    final url = Uri.parse(
        'https://fitnes-bakeend.onrender.com/update-fitnes/674729fc833f1cf20b63fe33');
  ...
  void callhttp(String id, String title, String description) async {
    ...
    try {
      final response = await http.put(
        ...
        body: json.encode({
          'id':
              '674729fc833f1cf20b63fe33', // Add 'id' (the MongoDB document ID)
