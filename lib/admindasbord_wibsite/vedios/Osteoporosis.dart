...
class Osteoporosis extends StatefulWidget {
  const Osteoporosis({super.key});

  @override
  State<Osteoporosis> createState() => _ChestvideospageState();
}

class _ChestvideospageState extends State<Osteoporosis> {
  List<Map<String, String>> chestVideos = [];

  @override
  void initState() {
    super.initState();
    searchById("Osteoporosis.email", 'chest');
  }
  ...
  void delethhtp(String id) async {
    ...
    try {
      final request = http.Request('DELETE', url)
        ...
        ..body = json.encode({
          'productId': "677244e4d1eb36a2280d3558",
        });
  ...
  void addvediotolist(String id, String title, String description) async {
    final url = Uri.parse(
        'https://fitnes-bakeend.onrender.com/update-fitnes/677244e4d1eb36a2280d3558');
  ...
  void callhttp(String id, String title, String description) async {
    ...
    try {
      final response = await http.put(
        ...
        body: json.encode({
          'id':
              '677244e4d1eb36a2280d3558', // Add 'id' (the MongoDB document ID)
