...
class Backvedios extends StatefulWidget {
  const Backvedios({super.key});

  @override
  State<Backvedios> createState() => _ChestvideospageState();
}

class _ChestvideospageState extends State<Backvedios> {
  List<Map<String, String>> chestVideos = [];

  @override
  void initState() {
    super.initState();
    searchById("back.email", 'chest');
  }
  ...
  void delethhtp(String id) async {
    ...
    try {
      final request = http.Request('DELETE', url)
        ...
        ..body = json.encode({
          'productId': "67472a41833f1cf20b63fe35",
        });
  ...
  void addvediotolist(String id, String title, String description) async {
    final url = Uri.parse(
        'https://fitnes-bakeend.onrender.com/update-fitnes/67472a41833f1cf20b63fe35');
  ...
  void callhttp(String id, String title, String description) async {
    ...
    try {
      final response = await http.put(
        ...
        body: json.encode({
          'id':
              '67472a41833f1cf20b63fe35', // Add 'id' (the MongoDB document ID)
