...
class Stress extends StatefulWidget {
  ...
  @override
  State<Stress> createState() => _ChestvideospageState();
}

class _ChestvideospageState extends State<Stress> {
  List<Map<String, String>> chestVideos = [];

  @override
  void initState() {
    super.initState();
    searchById("stress.email", 'chest');
  }
  ...
  void delethhtp(String id) async {
    ...
    try {
      final request = http.Request('DELETE', url)
        ...
        ..body = json.encode({
          'productId': "67724a3ad1eb36a2280d355a",
        });
  ...
  void addvediotolist(String id, String title, String description) async {
    final url = Uri.parse(
        'https://fitnes-bakeend.onrender.com/update-fitnes/67724a3ad1eb36a2280d355a');
  ...
  void callhttp(String id, String title, String description) async {
    ...
    try {
      final response = await http.put(
        ...
        body: json.encode({
          'id':
              '67724a3ad1eb36a2280d355a', // Add 'id' (the MongoDB document ID)
