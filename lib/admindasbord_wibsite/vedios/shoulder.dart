...
class Shoulder extends StatefulWidget {
  ...
  @override
  State<Shoulder> createState() => _ChestvideospageState();
}

class _ChestvideospageState extends State<Shoulder> {
  List<Map<String, String>> chestVideos = [];

  @override
  void initState() {
    super.initState();
    searchById("shoulder.email", 'chest');
  }
  ...
  void delethhtp(String id) async {
    ...
    try {
      final request = http.Request('DELETE', url)
        ...
        ..body = json.encode({
          'productId': "674726590f98bdbd51e2ea58",
        });
  ...
  void addvediotolist(String id, String title, String description) async {
    final url = Uri.parse(
        'https://fitnes-bakeend.onrender.com/update-fitnes/674726590f98bdbd51e2ea58');
  ...
  void callhttp(String id, String title, String description) async {
    ...
    try {
      final response = await http.put(
        ...
        body: json.encode({
          'id':
              '674726590f98bdbd51e2ea58', // Add 'id' (the MongoDB document ID)
