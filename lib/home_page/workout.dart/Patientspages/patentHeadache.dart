...
class Patentheadache extends StatefulWidget {
  const Patentheadache({super.key});

  @override
  _WorkoutPageState createState() => _WorkoutPageState();
}

class _WorkoutPageState extends State<Patentheadache> {
  ...
  void initState() {
    super.initState();
    loadString();
    searchById("headache.email", 'Trainng');
  }
