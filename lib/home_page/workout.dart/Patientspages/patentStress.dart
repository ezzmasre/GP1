...
class Patentstress extends StatefulWidget {
  const Patentstress({super.key});

  @override
  _WorkoutPageState createState() => _WorkoutPageState();
}

class _WorkoutPageState extends State<Patentstress> {
  ...
  void initState() {
    super.initState();
    loadString();
    searchById("stress.email", 'Trainng');
  }
