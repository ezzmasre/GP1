...
class Patentobesity extends StatefulWidget {
  const Patentobesity({super.key});

  @override
  _WorkoutPageState createState() => _WorkoutPageState();
}

class _WorkoutPageState extends State<Patentobesity> {
  ...
  void initState() {
    super.initState();
    loadString();
    searchById("Obesity.email", 'Trainng');
  }
