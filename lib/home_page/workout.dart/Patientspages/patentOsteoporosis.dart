...
class Patentosteoporosis extends StatefulWidget {
  const Patentosteoporosis({super.key});

  @override
  _WorkoutPageState createState() => _WorkoutPageState();
}

class _WorkoutPageState extends State<Patentosteoporosis> {
  ...
  void initState() {
    super.initState();
    loadString();
    searchById("Osteoporosis.email", 'Trainng');
  }
