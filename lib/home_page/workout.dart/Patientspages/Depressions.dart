...
class PatientsPage_Depressions extends StatefulWidget {
  const PatientsPage_Depressions({super.key});

  @override
  _WorkoutPageState createState() => _WorkoutPageState();
}

class _WorkoutPageState extends State<PatientsPage_Depressions> {
  ...
  void initState() {
    super.initState();
    loadString();
    searchById("Depression.email", 'Trainng');
  }
