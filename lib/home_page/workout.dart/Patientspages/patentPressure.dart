...
class Patentpressure extends StatefulWidget {
  const Patentpressure({super.key});

  @override
  _WorkoutPageState createState() => _WorkoutPageState();
}

class _WorkoutPageState extends State<Patentpressure> {
  ...
  void initState() {
    super.initState();
    loadString();
    searchById("pressure.email", 'Trainng');
  }
